            ...
            if col == unit_cross_section_area_supply_filter_col and not chart_inserted:
                ...
                if can_plot_brand1:
                    for i, (x_name, y_name) in enumerate(coord_col_pairs):
                        chart_data.append({
                            ...
                            # Modified Display_Label to distinguish left and right selections
                            'Display_Label': f"Left: {selected_brand1} - {selected_unit1}",
                ...
                if can_plot_brand2:
                    for i, (x_name, y_name) in enumerate(coord_col_pairs):
                        chart_data.append({
                            ...
                            # Modified Display_Label to distinguish left and right selections
                            'Display_Label': f"Right: {selected_brand2} - {selected_unit2}",
                            'Point_Order': i + 1 # Point order 1 to 5
                        })
                ...
                if chart_data: # Only attempt to plot if some data is gathered
                    ...
                    fig.update_layout(
                        ...
                        hovermode="x unified",
                        legend_title_text="Selection - Brand - Unit Name", # Renamed legend title
