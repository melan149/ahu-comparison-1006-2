...
internal_width_supply_fan_col = get_column_safe(df, ["Internal Width (Supply Fan)", "Internal Width Supply Fan"])
# Specific column to trigger chart display below it in the table
...
if not filtered_df1.empty and not filtered_df2.empty:
    ...
    for col in df.columns:
        ...
        if col not in excluded_cols:
            ...
            # Insert chart after "Internal Width (Supply Fan)" row
            if col == internal_width_supply_fan_col and not chart_inserted:
                ...
                if chart_data: # Only attempt to plot if some data is gathered
                    ...
                    fig.update_layout(
                        xaxis_title="Unit internal width_Supply Fan (mm)", # Renamed X-axis title
                        yaxis_title="Unit internal height_Supply Fan (mm)", # Renamed Y-axis title
                        hovermode="x unified",
